...
response = []
print("Hello! Welcome to Paul Jeschke's Madlib Extravaganza. You will provide responses to a series of prompts requesting verbs, nouns, and adjectives of varying specificity. Complete the prompts and enjoy an all-original madlib created by your very own Accounting Manager.\n")
# Next 4 lines provide the loop that populates our madlibs list of variables from user inputs
while counter < 13:
  print("#" + str(counter + 1) + " Provide " + (prompt[counter]))
